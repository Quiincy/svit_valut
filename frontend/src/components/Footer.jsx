          ...
          <div className="hidden lg:grid grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-text-secondary">
                <li><Link to={settings?.rates_url || '/rates'} className="hover:text-accent-yellow transition-colors">Курс валют</Link></li>
                <li><Link to={settings?.contacts_url || '/contacts'} className="hover:text-accent-yellow transition-colors">Контакти</Link></li>
                <li><a href="/#services" className="hover:text-accent-yellow transition-colors">Послуги</a></li>
                <li><Link to={settings?.faq_url || '/faq'} className="hover:text-accent-yellow transition-colors">FAQ</Link></li>
              </ul>
            </div>
