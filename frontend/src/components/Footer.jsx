    ...
    <footer id="footer" className="bg-primary-light border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="hidden lg:grid grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold text-lg">{settings?.company_name || 'ВАЛЮТ'}</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-text-secondary">
                <li><Link to="/rates" className="hover:text-white transition-colors">Курс валют</Link></li>
                <li><a href="#branches" className="hover:text-white transition-colors">Відділення</a></li>
        ...
        <div className="lg:hidden space-y-3 pb-6">
          <a href="#" className="block w-full py-4 bg-gradient-gold rounded-xl text-primary font-bold text-center">
            Забронювати валюту
          </a>
          {settings?.telegram_url && (
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-4 bg-primary border border-white/20 rounded-xl text-white font-medium"
            >
              <Send className="w-5 h-5" />
