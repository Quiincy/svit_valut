...
const defaultServices = [
  ...
  { id: 2, title: 'Приймаємо зношену валюту', description: 'Зручний спосіб позбутися непотрібних купюр. Приймаємо пошкоджені, зношені та написані банкноти за спеціальним курсом.', image_url: 'https://images.unsplash.com/photo-1611324477757-c947df087651?w=400&h=200&fit=crop', slug: 'damaged-currency' },
